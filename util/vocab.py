...
annotations = {
    ...
    'rsicd_precomp': ['train_caps.txt',  'test_caps.txt'], #'val_caps.txt',
    ...
    'nwpu_precomp':['train_caps.txt', 'test_caps.txt'],
    }
...
def main(data_path, data_name):
    ...
    serialize_vocab(vocab, '/home/mcx/RS/KAMCL-main/vocab/%s_vocab.json' % data_name)
    print("Saved vocabulary file to ", 'vocab/%s_vocab.json' %(data_name))

if __name__ == '__main__':
    parser = argparse.ArgumentParser()
    parser.add_argument('--data_path', default='/home/mcx/RS/KAMCL-main/data')
    parser.add_argument('--data_name', default='nwpu_precomp',
                        help='{coco,f30k}')
